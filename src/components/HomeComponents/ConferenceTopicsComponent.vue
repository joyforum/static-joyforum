<template>
    <v-row no-gutters class="mx-auto py-6 px-3" style="max-width: 1280px;">
        ...
        <v-col cols="6" v-for="topic in topicsArray" :key="topic[langKey].title" class="pa-1">
            <v-hover v-slot:default="{ hover }">
                <v-card flat class="border-radius-topics" :raised="hover" :height="$vuetify.breakpoint.smAndDown ? `150px` : `250px`" :style="
          ...
          ">
                    <div style="background-color: rgba(0,0,0,0.5); height: 100%;">
                        <v-fade-transition hide-on-leave>
                            <div v-if="!hover">
                                <div class="white--text text-center title hidden-sm-and-down" style="padding-top: 80px;">
                                    <span class="mont" v-html="topic[langKey].title"></span>
                                </div>
                                <div class="white--text text-center subtitle-2 hidden-md-and-up" style="padding-top: 40px;">
                  ...
                  ">
                                ...
                                <ul class="hidden-xs-only">
                                    <li v-for="(point, index) in topic[langKey].bulletPoints" :key="point" v-show="index < 3 || !$vuetify.breakpoint.smAndDown">
                                        <div :class="
                        $vuetify.breakpoint.smAndDown
                      ...
                      ">
                                ...
                                <div class="hidden-sm-and-up text-center">
                                    <v-btn small outlined color="white" class="mt-6" :to="isArabic ? `/conference/ar` : `/conference/en`">
                                        <span class="caption">
        ...
        <v-col cols="6" class="text-center mb-3 mt-9 mx-auto">
            <v-btn rounded outlined block color="primary" :to="isArabic ? `/conference/ar` : `/conference/en`">
